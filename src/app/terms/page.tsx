      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div style={{ color: '#2c1810', lineHeight: '1.9', fontSize: '1rem' }} className="space-y-6">
          ...
          <section>
            ...
            <p>
              מחולל העיתון ההיסטורי הוא כלי עזר חינוכי המיועד לתלמידי בגרות. התוכן המיוצר על ידי המערכת נוצר באמצעות בינה מלאכותית
          ...
          <section>
            ...
            <p>
              ...
              אקדמית, בחינות, או כל מטרה אחרת. התוכרים המיוצרים אינם מהווים מקור היסטורי מוסמך ואין להסתמך עליהם בלעדית.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              אין לשכפל, להפיץ או לעשות שימוש מסחרי בכלי זה ללא אישור בכתב מראש.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              הכתבות שאתה יוצר נשמרות בחשבונך האישי בלבד ואינן משותפות עם משתמשים אחרים.
              פרטי הזיהוי מנוהלים על ידי Clerk בהתאם למדיניות הפרטיות שלהם.
            </p>
          </section>

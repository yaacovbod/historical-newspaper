        ...
        <div className="space-y-8">
          ...
          <section>
            ...
            <div className="rounded-xl p-6" style={{ background: '#fffdf7', border: '1px solid #c9b99a' }}>
              ...
              <p style={{ color: '#5c3d1e', fontSize: '0.95rem', lineHeight: 1.8, marginBottom: '0.8rem' }}>
                כשהכתבה מוכנה — לחץ על <strong>"שמור כתבה"</strong> כדי לשמור אותה תחת "הכתבות שלי". הכתבה לא נשמרת אוטומטית.
              </p>
              <Tip>אם שיכללת את הכתבה לאחר שמירה — לחץ שוב על "שמור כתבה" כדי לשמור את הגרסה המעודכנת.</Tip>
            </div>
          </section>
